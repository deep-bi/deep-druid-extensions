...
public class AzureStorageDruidModule implements DruidModule {
    ...
    public List<? extends Module> getJacksonModules() {
        return ImmutableList.of(
                ...
                new SimpleModule().registerSubtypes(new NamedType(AzureInputSource.class, SCHEME)));
    }
        ...
        return Suppliers.memoize(() -> {
            try {
                ...
                if (config.getKey() != null) {
                    ...
                    throw new ISE("None of 'key' or 'sharedAccessStorageToken' is set in the azure config."
    ...
    @Provides
    @LazySingleton
    public AzureStorage getAzureStorageContainer(final Supplier<CloudBlobClient> cloudBlobClient) {
