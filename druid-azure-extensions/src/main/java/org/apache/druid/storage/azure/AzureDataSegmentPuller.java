...
public class AzureDataSegmentPuller {
    ...
    private final AzureUtils azureUtils;

    @Inject
    public AzureDataSegmentPuller(AzureByteSourceFactory byteSourceFactory, AzureUtils azureUtils) {
        this.byteSourceFactory = byteSourceFactory;
        this.azureUtils = azureUtils;
    }

    FileUtils.FileCopyResult getSegmentFiles(final String containerName, final String blobPath, final File outDir)
        ...
        try {
            ...
            final FileUtils.FileCopyResult result =
                    CompressionUtils.unzip(byteSource, outDir, AzureUtils.AZURE_RETRY, false);
