    ...
    private void fetchNextBatch() {
        try {
            log.debug(
                    ...
                    maxListingLength, currentContainer, currentPrefix);
            result = AzureUtils.retryAzureOperation(
                    () -> storage.listBlobsWithPrefixInContainerSegmented(
                            currentContainer, currentPrefix, continuationToken, maxListingLength),
                    config.getMaxTries());
