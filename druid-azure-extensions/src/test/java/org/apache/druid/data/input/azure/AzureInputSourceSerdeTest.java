...
public class AzureInputSourceSerdeTest extends EasyMockSupport {
    ...
    public void test_uriSerde_constructsProperAzureInputSource() throws Exception {
        ...
        final ObjectMapper objectMapper =
                new DefaultObjectMapper().registerModules(new AzureStorageDruidModule().getJacksonModules());
        ...
        final AzureInputSource roundTripInputSource =
                objectMapper.readValue(objectMapper.writeValueAsBytes(inputSource), AzureInputSource.class);
