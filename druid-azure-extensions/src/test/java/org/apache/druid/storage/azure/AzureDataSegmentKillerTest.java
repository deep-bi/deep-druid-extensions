...
public class AzureDataSegmentKillerTest extends EasyMockSupport {
    ...
    private static final StorageExtendedErrorInformation STORAGE_EXTENDED_ERROR_INFORMATION =
    ...
    public void killTest() throws SegmentLoadingException, URISyntaxException, StorageException {
        ...
        EasyMock.expect(azureStorage.emptyCloudBlobDirectory(CONTAINER_NAME, dirPath))
                .andReturn(deletedFiles);

        replayAll();

        AzureDataSegmentKiller killer = new AzureDataSegmentKiller(
                segmentConfig, inputDataConfig, accountConfig, azureStorage, azureCloudBlobIterableFactory);
    ...
    private void common_test_kill_StorageExceptionExtendedError_throwsException(
        ...
        EasyMock.expect(azureStorage.emptyCloudBlobDirectory(CONTAINER_NAME, dirPath))
                .andThrow(new StorageException("", "", 400, storageExtendedErrorInformation, null));
