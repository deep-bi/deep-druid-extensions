...
public class AzureStorageDruidModuleTest extends EasyMockSupport {
    ...
    static {
        try {
            ...
            AZURE_ACCOUNT_KEY = Base64.getUrlEncoder().encodeToString("azureKey1".getBytes(StandardCharsets.UTF_8));
    ...
    public void testGetBlobClientExpectedClient() {
        ...
        Supplier<CloudBlobClient> cloudBlobClient =
                injector.getInstance(Key.get(new TypeLiteral<Supplier<CloudBlobClient>>() {}));
    ...
    public void testBothAccountKeyAndSAStokenSet() {
        ...
        expectedException.expectMessage(
                "Either set 'key' or 'sharedAccessStorageToken' in the azure config but not both");
                ...
                new Module() {
                    ...
                    public void configure(Binder binder) {
                        binder.bind(Validator.class)
                                .toInstance(Validation.buildDefaultValidatorFactory()
                                        .getValidator());
