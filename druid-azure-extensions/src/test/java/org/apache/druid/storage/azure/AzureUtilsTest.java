...
public class AzureUtilsTest {
    ...
    private static final String BLOB_PATH_WITH_LEADING_AZURE_PREFIX =
            AzureUtils.DEFAULT_AZURE_BLOB_STORAGE_ENDPOINT_SUFFIX + "/" + BLOB_NAME;
    ...
    private static final RuntimeException IO_EXCEPTION_WRAPPED_IN_RUNTIME_EXCEPTION =
            new RuntimeException("", new IOException());
    private static final RuntimeException RUNTIME_EXCEPTION_WRAPPED_IN_RUNTIME_EXCEPTON =
            new RuntimeException("", new RuntimeException());

    static {
        try {
            URI_WITH_PATH_WITH_LEADING_SLASH =
                    new URI(AzureInputSource.SCHEME + "://" + CONTAINER_NAME + BLOB_PATH_WITH_LEADING_SLASH);
        } catch (Exception e) {
