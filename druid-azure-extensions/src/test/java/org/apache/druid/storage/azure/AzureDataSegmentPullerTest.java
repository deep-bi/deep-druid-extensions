...
public class AzureDataSegmentPullerTest extends EasyMockSupport {
    ...
    private static final String BLOB_PATH_HADOOP =
            AzureUtils.DEFAULT_AZURE_BLOB_STORAGE_ENDPOINT_SUFFIX + "/path/to/storage/index.zip";
    ...
    public void test_getSegmentFiles_success()
        ...
        try {
            ...
            EasyMock.expect(azureStorage.getBlobInputStream(0L, CONTAINER_NAME, BLOB_PATH))
                    .andReturn(zipStream);
    ...
    public void test_getSegmentFiles_recoverableErrorRaisedWhenPullingSegmentFiles_deleteOutputDirectory()
        ...
        try {
            EasyMock.expect(byteSourceFactory.create(CONTAINER_NAME, BLOB_PATH))
                    .andReturn(new AzureByteSource(azureStorage, CONTAINER_NAME, BLOB_PATH));
            EasyMock.expect(azureStorage.getBlobInputStream(0L, CONTAINER_NAME, BLOB_PATH))
                    .andThrow(new StorageException(null, null, 0, null, null))
                    .atLeastOnce();
