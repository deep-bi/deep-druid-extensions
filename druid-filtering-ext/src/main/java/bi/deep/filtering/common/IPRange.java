...
public class IPRange {
    ...
    public IPRange(String range) {
        ...
        final String[] parts = range.split(SEPARATOR);
        ...
        final IPAddress lower = new IPAddressString(parts[0]).getAddress();
        final IPAddress upper = new IPAddressString(parts[1]).getAddress();
        ...
        if (lower.getIPVersion() != upper.getIPVersion()) {
    ...
    public boolean contain(final IPAddress address) {
