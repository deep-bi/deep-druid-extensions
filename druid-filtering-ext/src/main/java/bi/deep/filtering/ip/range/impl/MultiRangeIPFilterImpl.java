...
public class MultiRangeIPFilterImpl implements Filter {
    ...
    public MultiRangeIPFilterImpl(String column, Set<IPRange> ranges, @Nullable Boolean ignoreVersionMismatch) {
    ...
    public boolean contain(@NotNull final String addressStr) {
        ...
        if (ipAddress.isIPv4() && !ipV4Ranges.isEmpty()) {
            ...
            return ipV6Ranges.stream().anyMatch(range -> range.contain(ipAddress));
        }
